...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/particula.css'); ?>" />
                            ...
                            <div class="card card-cad">
                                <div class="content">
                                    <div id="newlog">
                                        ...
                                        <div class="title01">
                                            <img src="<?php echo base_url() ?>assets/img/logo-branco.png">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="main_input_box">
                                                ...
                                                <input id="email" name="email" type="text" placeholder="Email" value="<?php echo trim($parse_email); ?>" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="main_input_box">
                                                ...
                                                <input id="documento" class="cpfcnpj" maxlength="18" size="18" name="documento" type="text" placeholder="CPF/CNPJ" value="<?php echo trim($parse_cpfcnpj); ?>" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="links-uteis">
                                        <a href="https://autocrm.com.br/">
                                            <p><?= date('Y'); ?> &copy; Auto CRM</p>
                                        </a>
                                        <a href="https://github.com/RamonSilva20/mapos">
                                            <p>Baseado no MapOS</p>
                                        </a>
                                    </div>
                                </div>
                            </div>
