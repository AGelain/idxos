                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    <div class="span12" style="padding: 1%">
                                        ...
                                        <div class="span3">
                                            ...
                                            <input id="veiculo" class="span12" type="text" name="veiculo" value="" readonly />
                                            <input id="veiculo_id" class="span12" type="hidden" name="veiculo_id" value="" />
                                        </div>
                                        <div class="span3">
                                        ...
                                        <div class="span2">
                                            ...
                                            <input id="km" class="span12" type="number" name="km" value="<?= $this->session->userdata('km'); ?>" />
                                        </div>
                                    </div>
        ...
        $("#cliente").autocomplete({
            ...
            select: function(event, ui) {
                ...
                $("#veiculo").autocomplete({
                    source: "<?php echo base_url(); ?>index.php/veiculos/autoCompleteVeiculoByCliente/" + ui.item.id,
                    minLength: 1,
                    select: function(event, ui) {
