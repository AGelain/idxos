                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                      ...
                      <?php if($this->data['configuration']['usar_assinatura']): ?>
                        <li id="tabAssinatura"><a href="#tabAssinaturas" data-toggle="tab">Assinaturas</a></li>
                      <?php endif; ?>
                    </ul>
                            ...
                            <div class="span12" id="divCadastrarOs">
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span3">
                                            <label for="veiculo">Veículo<span class="required">*</span></label>
                                            <input id="veiculo" class="span12" type="text" name="veiculo" value="<?php echo $result->placa ?>" />
                                            <input id="veiculo_id" class="span12" type="hidden" name="veiculo_id" value="<?php echo $result->veiculo_id ?>" />
                                        </div>
                                        <div class="span3">
                                        ...
                                        <div class="span2">
                                            <label for="km">Km<span class="required">*</span></label>
                                            <input id="km" class="span12" type="number" name="km" value="<?php echo $result->km ?>" />
                                        </div>
                                    </div>
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
