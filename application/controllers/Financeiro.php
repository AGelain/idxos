...
class Financeiro extends MY_Controller
{
    ...
    public function despesas()
    {
        ...
        $this->data['menuFinanceiro'] = 'financeiroDespesas';
        ...
        $this->data['view'] = 'financeiro/despesas';
        return $this->layout();
    }
    ...
    {
        if (!$this->permission->checkPermission($this->session->userdata('permissao'), 'vLancamento')) {
            $this->session->set_flashdata('error', 'Você não tem permissão para visualizar receitas.');
            redirect(base_url());
        }
        $this->data['menuFinanceiro'] = 'financeiroReceitas';
        ...
        $this->data['view'] = 'financeiro/receitas';
        return $this->layout();
    }
