...
class Os_model extends CI_Model
{
    ...
    public function getOs($table, $fields, $where = [], $perpage = 0, $start = 0, $one = false, $array = 'array')
    {
        ...
        $this->db->select($fields . ',clientes.idClientes, veiculos.placa, clientes.nomeCliente, clientes.celular as celular_cliente, usuarios.nome, garantias.*');
        $this->db->from($table);
        $this->db->join('clientes', 'clientes.idClientes = os.clientes_id');
    ...
    {
        $this->db->select('os.*, clientes.*, veiculos.placa, clientes.celular as celular_cliente, clientes.telefone as telefone_cliente, clientes.contato as contato_cliente, garantias.refGarantia, garantias.textoGarantia, usuarios.telefone as telefone_usuario, usuarios.email as email_usuario, usuarios.nome');
        $this->db->from('os');
        $this->db->join('clientes', 'clientes.idClientes = os.clientes_id');
        $this->db->join('veiculos', 'veiculos.idVeiculos = os.veiculo_id');
        $this->db->join('usuarios', 'usuarios.idUsuarios = os.usuarios_id');
